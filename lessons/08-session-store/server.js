...
app.listen(PORT, () => {
  console.log(`\\n${'='.repeat(50)}`);
  console.log('💾 Lesson 08: Session Store (Redis/Database)');
  console.log('='.repeat(50));
  console.log(`✅ Server running at http://localhost:${PORT}`);
  console.log('   Note: This demo uses cookie-session');
  console.log('   For production, use express-session with Redis');
  console.log('='.repeat(50) + '\\n');
});
